...
/*
  Generated class for the FoodByType page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
  */
  @Component({
  	selector: 'page-food-by-type',
  	templateUrl: 'food-by-type.html'
  })
  export class FoodByTypePage {
  	category: string;
  	curCat: any;
  	allCat: Array<any>;
  	foodByCat: Array<any>;
  	...
  	openModalNewFood(){
  		let modal = this.modalCtrl.create(ModalCreateFoodPage, {categories: this.allCat, curCat: this.category});
  		modal.present();
